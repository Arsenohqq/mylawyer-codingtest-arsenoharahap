...
export type IBookingState = IPaginationBaseState;
            ...
            <Table responsive aria-describedby="booking-heading">
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('bookingId')}>
                    Booking Id <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('bookingName')}>
                    Booking Name <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('paymentApproved')}>
                    Payment Approved <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
              ...
              <tbody>
                {bookingList.map((booking, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{booking.paymentApproved ? 'true' : 'false'}</td>
                    <td>{booking.lawyerIdId ? <Link to={`lawyer/${booking.lawyerIdId}`}>{booking.lawyerIdId}</Link> : ''}</td>
